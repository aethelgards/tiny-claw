...
func (m *ApprovalManager) WaitingForApproval(ctx context.Context, taskID, toolName, args string, reporter reporter.Reporter, approverOpenID string) (bool, string) {
	task := approvalTask{
